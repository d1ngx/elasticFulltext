kodReady.push(function(){
	...
	$('<style id="elastic-fulltext-admin-style">.elastic-fulltext-action.btn-sm{padding:5px 13px!important;font-size:13px!important;line-height:1.4!important;min-width:88px}.elastic-fulltext-action.is-busy{opacity:.85;pointer-events:none}.elastic-fulltext-status{line-height:1.5;font-size:13px;max-width:480px}.elastic-fulltext-es{margin-bottom:8px}.elastic-fulltext-metrics{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:8px 24px;margin:0 0 10px}.elastic-fulltext-stat{display:flex;align-items:baseline;gap:10px;min-width:0}.elastic-fulltext-stat.is-wide{grid-column:1/-1}.elastic-fulltext-status .k{flex:0 0 2em;color:#888}.elastic-fulltext-status .v{min-width:0;font-variant-numeric:tabular-nums;white-space:nowrap}.elastic-fulltext-note{color:#666;margin:2px 0;display:flex;gap:10px}.elastic-fulltext-error{color:#c62828;margin-top:4px}.elastic-fulltext-status-actions{margin-top:8px}.elastic-fulltext-status-actions .btn+.btn{margin-left:6px}.elastic-fulltext-dot{display:inline-block;width:8px;height:8px;border-radius:50%;background:#2196f3;margin-right:8px;vertical-align:middle}.elastic-fulltext-dot.is-loading{animation:elasticPulse 1s infinite alternate}.elastic-fulltext-progress{display:flex;flex-direction:column;gap:4px;margin:0 0 10px;padding:8px 10px;background:#eef6ff;border:1px solid #c5ddf7;border-radius:4px;color:#1565c0}.elastic-fulltext-progress-head{display:flex;align-items:center;justify-content:space-between;gap:12px}.elastic-fulltext-progress-name{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:12px;opacity:.9}.elastic-fulltext-test-msg{display:inline-block;margin-left:8px;min-height:20px;vertical-align:middle}.elastic-fulltext-test-msg.is-wait{color:#1565c0}.elastic-fulltext-test-msg.is-ok{color:#20a53a}.elastic-fulltext-test-msg.is-fail{color:#d9822b}@keyframes elasticPulse{to{opacity:.25}}</style>').appendTo('head');
